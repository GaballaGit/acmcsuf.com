...
<details {id} style:--highlights={data.teamColor} class="position">
  ...
  <div class="position__body">
    ...
    <div class="position__responsibilities">
      <h3 class="acm-heavier">Responsibilities</h3>
